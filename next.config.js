module.exports = {
  ...
  // Fix "dark" mode not being applied properly in @apply rules in .module.css files
  // See https://github.com/tailwindlabs/tailwindcss/issues/3258#issuecomment-967221245
  webpack: (config) => {
